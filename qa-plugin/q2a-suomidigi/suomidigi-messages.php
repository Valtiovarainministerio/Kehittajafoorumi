...
//	Prepare content for theme
	...
	// KF: Show subnav
	$qa_content['navigation']['sub'] = qa_user_sub_navigation(qa_get_logged_in_handle(), 'messages', true);
	
	$inbox_link  = qa_opt('site_url').'messages';
	$outbox_link = qa_opt('site_url').'messages/sent';

	$qa_content['sub-navi-second']='<br/>
							<div class="qa-nav-sub qa-nav-sub-messages">
							<ul class="qa-nav-sub-list">
								<li class="qa-nav-sub-item qa-nav-sub-inbox">
									<a href="'.$inbox_link.'" class="qa-nav-sub-link '.((!$showOutbox)?'qa-nav-sub-selected':'').'">'.qa_lang_html('misc/inbox').'</a>
								</li>
								<li class="qa-nav-sub-item qa-nav-sub-outbox">
									<a href="'.$outbox_link.'" class="qa-nav-sub-link '.(($showOutbox)?'qa-nav-sub-selected':'').'">'.qa_lang_html('misc/outbox').'</a>
								</li>
							</ul>
